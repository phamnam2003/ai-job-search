...
invalid. All ten applications sent in the 07/2026 – 08/2026 round were English, including the ones
answering Vietnamese-language postings (TeenUp, LoogIX). That archive was cleared on 2026-08-05
after the round closed out with no offers — the rule stands on its own, the files are gone.
...
<!-- Extracted by /setup on 2026-08-03 from the 10 cover letters then in documents/applications/.
     These describe what has actually been sent, not new rules. The source letters were deleted
     on 2026-08-05 (round closed out, no offers); these distilled patterns are what survives. -->
