...
% Languages and References share one heading on purpose. Each was a section
% holding a single line, and a moderncv section heading costs far more vertical
% space than the line under it - merging them reclaimed the room the
% Open-Source Projects section needed without dropping a word of either. Split
% them back into two sections if a tailored copy has the space.
