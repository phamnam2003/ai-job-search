...
% Stretch page 2 by a few lines so References does not spill to a page 3 on its
% own. The standard near-miss rescue per 05-cv-templates.md - compressing the
% geometry or the \vspace values instead is explicitly ruled out there.
\enlargethispage{4\baselineskip}
\section{Awards}
\vspace{1pt}
\begin{itemize}
\item \textbf{2nd prize, Faculty-level Student Scientific Research} (2024), Hanoi Open University --- research topic: Agile in software development.
